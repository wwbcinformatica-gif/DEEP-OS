...
Monitor your context usage and shift behavior as you climb the tiers. The point is to notice _before_ you hit the wall, not when responses start truncating.
